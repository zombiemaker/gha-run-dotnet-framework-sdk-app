    ...
    switch ($DotnetFrameworkVersion) {
        {$_ -in "4.8", "4.7.2", "4.7.1", "4.7", "4.6.2"} {
            ...
            if ($PowerShellHostWorkingDirectory -eq $null) {
                ...
                write-host "docker run --rm -v `"$PowerShellHostWorkingDirectory`":`"\Users\ContainerAdministrator\Documents`" -w `"c:\Users\ContainerAdministrator\Documents`" mcr.microsoft.com/dotnet/framework/sdk:4.8 $CommandString"
                # Had issues with quotations in the $CommandString when executing docker program
                ...
                & docker run --rm -v "$PowerShellHostWorkingDirectory":"\Users\ContainerAdministrator\Documents" -w "c:\Users\ContainerAdministrator\Documents" mcr.microsoft.com/dotnet/framework/sdk:4.8 $CommandString
            }
        ...
        {$_ -in "3.5", "3.0", "2.5"} { 
            ...
            if ($PowerShellHostWorkingDirectory -eq $null) {
                ...
                write-host "docker run --rm -v `"$PowerShellHostWorkingDirectory`":`"\Users\ContainerAdministrator\Documents`" -w `"c:\Users\ContainerAdministrator\Documents`" mcr.microsoft.com/dotnet/framework/sdk:3.5 $CommandString"
                # Had issues with quotations in the $CommandString when executing docker program
                #Invoke-Expression "docker run --rm -v '$($PowerShellHostWorkingDirectory):c:/Users/ContainerAdministrator/Documents' -w 'c:/Users/ContainerAdministrator/Documents' mcr.microsoft.com/dotnet/framework/sdk:3.5 $CommandString"
                & docker run --rm -v "$PowerShellHostWorkingDirectory":"\Users\ContainerAdministrator\Documents" -w "c:\Users\ContainerAdministrator\Documents" mcr.microsoft.com/dotnet/framework/sdk:3.5 $CommandString
            }
            continue
        }
